...
This gave us the final model which includes the predictor variables `time_of_day`, `subscriberCount`, `category`, `num_caps`, `num_exc`, `desc_length`, `video_length` and the iteractions between `category` and both `desc_length` and `subscriberCount`. Our final model is shown below.
\newpage
...
|$R^2$| AIC | BIC| degrees of freedom |
|---|---|---|---|
|0.3396|2777.482|3016.621|47|
