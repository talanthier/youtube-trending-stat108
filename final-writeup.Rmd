...
From our analysis, we find most of the variables are not very helpful in explaining the differences in log view count across videos. Most notably, subscriber count is very important. Trending videos uploaded by channels with a larger subscriber counts tend to have larger view counts. Additionally the number of capital letters in the title is useful. It seems that a larger number of capital letters in the title is associated with smaller view counts. Interpreting the coefficient, holding all else constant, by increasing the number of capital letters in the title by 1 we would expect the view count of the video to be multiplied by a factor of $e^{-0.0085} = 0.992$. While this is statistically significant, it doesn't appear to be practically significant.
